...
class AlertManager:
    ...
    def send_email_alert(self, alert: Dict, recipients: List[str]) -> bool:
        ...
        try:
            ...
            # Compose email
            subject = f"🚨 ALERT: {alert['arm_id']} - {alert['severity'].upper()} Priority"
                ...
                "attachments": [
                    {
                        ...
                        "fields": [
                            ...
                            {"title": "Failure Probability", "value": f"{alert['failure_probability']:.1%}", "short": True},
                            {"title": "Health Score", "value": f"{alert['health_score']:.1f}%", "short": True},
                            {"title": "Estimated Cost", "value": alert['estimated_replacement_cost'], "short": True},
                            {"title": "Recommendation", "value": alert['maintenance_action'], "short": False}
                        ],
